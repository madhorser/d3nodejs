...
<script type="text/javascript">
	...
	var nodeDataStr;
	nui.ajax({
	    url: "<%=request.getContextPath()%>/analyseCmd.do?invoke=getAnalyseNode&displayType=2&analyseType=lineage&instanceId=" + instanceId,
	...
	var linkDataStr;
	nui.ajax({
	    url: "<%=request.getContextPath()%>/analyseCmd.do?invoke=getAnalyseLink&displayType=2&analyseType=lineage&instanceId=" + instanceId,
	    contentType: 'text/json',
	    async : false,
		success: function (text) {
			var strToObj=JSON.parse(text);
