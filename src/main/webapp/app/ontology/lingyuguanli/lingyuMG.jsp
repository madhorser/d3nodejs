	...
	<div class="menu">
		<div class="min-menu">
		    <ul id="myTab" class="nav nav-pills" role="tablist">
		        <li role="presentation" class="active"><a href="#home" data-toggle="tab" id="home_tab" title="领域管理列表"></a></li>
		    </ul>
		</div>
		<div class="content" style="height:100%">
            ...
            <div class="tab-content">
                <div id="home" class="tab-pane fade in active">领域管理列表</div>
            </div>
		</div>
	</div>
</div>
