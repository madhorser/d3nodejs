	...
	<div class="menu">
		<div class="min-menu">
		    <ul id="myTab" class="nav nav-pills" role="tablist">
		        <li role="presentation" class="active"><a href="#home" data-toggle="tab" id="home_tab" title="本体查询"></a></li>
		        <li role="presentation"><a href="#index" data-toggle="tab" title="本体关系详情"></a></li>
		        <li role="presentation"><a href="#report" data-toggle="tab" title="修改删除关系"></a></li>
		    </ul>
		</div>
		<div class="content" style="height:100%">
            ...
            <div class="tab-content">
                <div id="home" class="tab-pane fade in active">本体查询</div>
                <div id="index" class="tab-pane fade">本体关系详情</div>
                <div id="report" class="tab-pane fade">修改删除关系</div>
            </div>
		</div>
	</div>
</div>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
		    ...
		    function formateString(str,obj){
	   		...
	   		var jsonObj={
  					home:[{pageSrc:"ontologQuery.jsp"}],
  					index:[{pageSrc:"ontologyRelDetails.jsp"}],
  					report:[{pageSrc:"ontologyCRUD.jsp"}]
	   		}
