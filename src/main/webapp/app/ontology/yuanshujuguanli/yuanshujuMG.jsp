	...
	<div class="menu">
		<div class="min-menu">
		    <ul id="myTab" class="nav nav-pills" role="tablist">
		        <li role="presentation" class="active"><a href="#home" data-toggle="tab" id="home_tab" title="文本相似度建立关系任务"></a></li>
		        <li role="presentation"><a href="#index" data-toggle="tab" title="文本相似度建立关系任务结果"></a></li>
		        <li role="presentation"><a href="#report" data-toggle="tab" title="文本相似度建立关系查询"></a></li>
		        <li role="presentation"><a href="#database" data-toggle="tab" title="手工调整元数据关系"></a></li>
		        <li role="presentation"><a href="#inforItem" data-toggle="tab" title="新增文本相似度关系"></a></li>
		    </ul>
		</div>
		<div class="content" style="height:100%">
            ...
            <div class="tab-content">
                <div id="home" class="tab-pane fade in active">文本相似度建立关系任务</div>
                <div id="index" class="tab-pane fade">文本相似度建立关系任务结果</div>
                <div id="report" class="tab-pane fade">文本相似度建立关系查询</div>
                <div id="database" class="tab-pane fade">手工调整元数据关系</div>
                <div id="inforItem" class="tab-pane fade">新增文本相似度关系</div>
            </div>
		</div>
	</div>
</div>
