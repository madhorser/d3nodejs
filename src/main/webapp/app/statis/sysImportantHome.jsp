...
<body>
	...
	<div id="sysHome" style="height:400px;width:400px"></div>
       ...
       var url = "<%=request.getContextPath()%>/statistics.do?invoke=sysImportant";
		...
		function testcall() {
			...
			require([ 'echarts', 'echarts/chart/scatter', // 使用柱状图就加载bar模块，按需加载
				...
				var worldMapContainer = document.getElementById('sysHome');
				...
				var myChart = ec.init(document.getElementById('sysHome'),
						'macarons');
