 ...
 * @xtype displayfield
 */
Ext.form.DisplayFieldUx = Ext.extend(Ext.form.Field,  {
    ...
    /**
     * @cfg {Boolean} gray True to set the font color to gray, default is false.
     */
    gray: false,
    ...
    initComponent : function(){
        if (this.gray === true) {
            this.defaultAutoCreate['style'] = 'color:#7f7f7f;';
        }
        Ext.form.DisplayFieldUx.superclass.initComponent.call(this);
    },
...
Ext.reg('displayfieldux', Ext.form.DisplayFieldUx);
