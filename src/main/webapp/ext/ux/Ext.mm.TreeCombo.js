...
/**
 * 树型下拉框: 元数据树、元模型树。
 * @class Ext.mm.TreeCombo
 * @extends Ext.form.ComboBox
 * @author huanglp 黄龙平
 * @version 1.0 2011-04-26
 */
Ext.mm.TreeCombo=Ext.extend(Ext.form.ComboBox, {
    shadow : 'sides',
    ...
    initComponent : function() {
        Ext.mm.TreeCombo.superclass.initComponent.call(this);
        this.pageSize = false;
    ...
    onRender : function(ct, position) {
        Ext.mm.TreeCombo.superclass.onRender.call(this, ct, position);
    },
    ...
    expand : function(){
        Ext.mm.TreeCombo.superclass.expand.call(this);
    ...
    validateValue : function(value) {
        return Ext.mm.TreeCombo.superclass.validateValue.call(this, value);
    },
    ...
    onDestroy : function() {
        ...
        Ext.mm.TreeCombo.superclass.onDestroy.call(this);
    },
    ...
    initValue: function() {
        Ext.mm.TreeCombo.superclass.initValue.call(this);
    ...
    getValue : function(){
        if(this.hiddenField){
            ...
            return Ext.mm.TreeCombo.superclass.getValue.call(this);
        }
    },
    ...
    setValue : function(node) {
        ...
        if(Ext.type(node) == 'object'){
            Ext.mm.TreeCombo.superclass.setValue.call(this, node.text);
    ...
    clearValue : function(){
        Ext.mm.TreeCombo.superclass.clearValue.call(this);
        this.collapse();
    ...
    reset : function(){
        ...
        Ext.mm.TreeCombo.superclass.reset.call(this);
    },
    ...
    createClassifyTree: function() {
        var tree = MetamodelTree.Public.createMetamodelTree({
            rootVisible: false,
            border: false,
            bodyBorder: false,
            autoScroll: true,
...
Ext.reg('mmtreecombo', Ext.mm.TreeCombo);